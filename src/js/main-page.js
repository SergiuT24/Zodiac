		...
		zodiacSigns.forEach(signName => {
			...
			const myPopup = new Popup({
				...
				content: `
						...
						<div class="popup-body_text">${jsonData[formattedDate][signName]}<br><br><a class="popup-body_link" href="/zodii/${signName}.html">Află mai multe despre ${signName.charAt(0).toUpperCase() + word.slice(1)}</a></div>
						`,
			});
